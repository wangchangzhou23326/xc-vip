...
import com.dksvip.common.annotation.RateLimiter;
import com.dksvip.common.constant.LimitType;
import com.dksvip.common.exception.RxLoginCallException;
import com.dksvip.core.web.redis.RedisUtil;
import com.dksvip.core.web.util.IpUtils;
...
public class RateLimiterAspect
{
    ...
    public void doBefore(JoinPoint point, RateLimiter rateLimiter) throws Throwable
    {
        ...
        try
        {
            ...
            {
                throw new RxLoginCallException("访问过于频繁，请稍候再试");
            }
